...
do
    ...
    python -u main.py --input_dir "./symp_dataset_tiny" --bs 64 --feat_type prob --sel_disease depression --exp_name tiny_depression_concat --lr 0.01 --write_result_dir ./lightning_logs/records_concat_666.json
